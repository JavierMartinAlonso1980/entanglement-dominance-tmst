...
This software reproduces **Theorem 4.3.1** and **Figure 4.1** of the manuscript [file:2]. It maps the phase transition between thermal separability and topological entanglement in symmetric **Two-Mode Squeezed Thermal (TMST)** states.
